...
class Config():
    ...
    # 在数据库中不必要增加或者显示的课程
    NOT_SHOW_COURSENAME = ['田径（一）', '田径（二）', '思政课社会实践', '乒乓球（一）', '乒乓球（二）', '体育保健', '网球（一）', '网球（二）', '羽毛球（一）',
                           '羽毛球（二）', '羽毛球（三）', '羽毛球（四）', '户外运动（一）', '户外运动（二）', '户外运动（三）', '户外运动（四）',
                           '手球（一）', '手球（二）', '手球（三）', '手球（四）' \
                                                      '排球（一）', '排球（一）', '排球（二）', '排球（三）', '排球（四）', '网球（一）', '网球（二）',
                           '网球（三）', '网球（四）', '足球（一）', '足球（二）', '足球（三）', '足球（四）', '篮球（一）', '篮球（二）', \
                           '篮球（三）', '篮球（四）', '大众健美操（一）', '大众健美操（二）', '传统武术（一）', \
                           '传统武术（二）', '瑜伽（一）', '瑜伽（二）', '舞龙（一）', '舞龙（二）', '龙舟运动（一）', '龙舟运动（二）', '龙舟运动（三）', '龙舟运动（四）', \
                           '散打（一）', '散打（二）', '啦啦操（一）', '啦啦操（二）', '健美（一）', '健美（二）', '啦啦操（一）', '太急柔力球（一）', '太急柔力球（二）',
                           '跆拳道（一）', '跆拳道（二）', '双健（一）', '双健（二）', \
                           '橄榄球（一）', '橄榄球（二）', '跑射联项（一）', '跑射联项（二）',
                           '体育保健（一）', '体育保健（二）', '太极柔力球（一）', '太极柔力球（二）', '毽球（一）', '毽球（二）', '体育舞蹈（一）', '体育舞蹈（二）',
                           '乒乓球（一）', '乒乓球（二）', '乒乓球（三）', '乒乓球（四）', \
                           '女子形体（一）', '女子形体（二）', '女子形体（三）', '女子形体（四）', '机械设计理论与方法（一）上', '工程制图（一）', '工程化学']
    ...
    HOSTNAME = 'localhost'
    PORT = '3306'
    # DATABASE = 'studentscorredise'
    DATABASE = 'termsystem'
    USERNAME = 'root'
    PASSWORD = 'jzj123'
    DB_URI = 'mysql+pymysql://{}:{}@{}:{}/{}?charset=utf8'.format(USERNAME, PASSWORD, HOSTNAME, PORT, DATABASE)
    DB_URI_async = 'mysql+aiomysql://{}:{}@{}:{}/{}?charset=utf8'.format(USERNAME, PASSWORD, HOSTNAME, PORT, DATABASE)
