...
class CourseByTermTable(Base):
    ...
    failedNums = Column(LONGTEXT, nullable=False)
    gradeDistribute = Column(LONGTEXT, nullable=False)
    passRate = Column(LONGTEXT, nullable=False)
...
class ClassByTermChart(Base):
    ...
    major = Column(LONGTEXT, nullable=False)
    cls = Column(LONGTEXT, nullable=False)


class MajorByTermChart(Base):
    """
    专业维度数据 图
    {
        "term": "11",
    ...
    __tablename__ = "majorByTermChart"

    term = Column(String(2), primary_key=True)
    major = Column(String(10), primary_key=True)
...
class GradeByTermChart(Base):
    ...
    __tablename__ = "gradeByTermChart"

    term = Column(String(2), primary_key=True)
    grade = Column(String(2), primary_key=True)
    courseName = Column(LONGTEXT, nullable=False)
    failedNums = Column(String(200), nullable=False)
    failedRates = Column(String(200), nullable=False)
...
class StudentInfo(Base):
    ...
    sumFailedCredit = Column(Float, nullable=True)
    totalCredit = Column(Float, nullable=True)
    failedSubjectNumsTerm = Column(String(100), nullable=True)  # 每学年挂科数量
    totalWeightedScoreTerm = Column(String(100), nullable=True)  # 每学加权平均分
    totalFailedCreditTerm = Column(String(100), nullable=True)  # 每学年不及格学分
